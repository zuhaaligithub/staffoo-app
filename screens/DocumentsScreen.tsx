...
export default function DocumentsScreen({ navigation }: Props) {
  ...
  const renderFilledCard = (item: Document) => {
    ...
    return (
      <LinearGradient
        colors={["#0D1421", "#0D1421"]}
        style={[
          styles.cardGradientWrapper,
          {
            // borderStyle: "dashed",
            borderWidth: 1,
            borderColor: "rgba(62, 62, 62, 0.92)",
          },
        ]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
        ...
        <View style={styles.cardInnerContainer}>
          <View style={styles.cardTopRow}>
            <View style={styles.docIconBox}>
              <FileText size={18} color={THEME.teal} />
            </View>
          ...
          <View style={styles.cardActionsRow}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Pencil size={14} color={THEME.teal} style={{ marginRight: 6 }} />
            ...
            <View style={styles.pointsCardHeaderRow}>
              ...
              <View style={styles.pointsBadge}>
                <Text style={styles.pointsBadgeText}>
                  {staffDocumentPointsRaw >= 100
                    ? "100+ Points"
                    : `${staffDocumentPointsRaw} Points`}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.pointsProgressTrack}>
              <View
                style={[
                  ...
                  {
                    width: `${Math.min(
                      staffDocumentCompletionPercentage,
                      100,
                    )}%`,
                  },
                ]}
            ...
            {isStaffDocumentsComplete ? (
              ...
              <View style={styles.pointsMetRow}>
                ...
                <Text style={styles.pointsNeededText}>
                  {Math.max(100 - staffDocumentPointsRaw, 0)} more point
                  {Math.max(100 - staffDocumentPointsRaw, 0) === 1
                    ? ""
                    : "s"}{" "}
                  needed to proceed.
                </Text>
...
const styles = StyleSheet.create({
  ...
  editBtnText: { color: THEME.teal, fontSize: 11, fontWeight: "bold" },
