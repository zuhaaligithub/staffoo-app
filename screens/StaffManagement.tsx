      ...
      <View style={docStyles.docOverlay}>
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (!isExpiryLocked) setShowInlineCalendar(true);
            }}
          >
            <Text
              style={[
        ...
        <Modal
          ...
          transparent
          animationType="fade"
          onRequestClose={() => setShowInlineCalendar(false)}
        >
          <TouchableWithoutFeedback
            onPress={() => setShowInlineCalendar(false)}
          >
            <View style={docStyles.calendarModalOverlay}>
              <TouchableWithoutFeedback>
                <View style={docStyles.inlineCalendar}>
                  ...
                  <TouchableOpacity
                    style={docStyles.calendarCloseBtn}
                    onPress={() => setShowInlineCalendar(false)}
                  >
                    <Text style={docStyles.calendarCloseBtnText}>Close</Text>
                  </TouchableOpacity>
                </View>
              </TouchableWithoutFeedback>
            </View>
...
const docStyles = StyleSheet.create({
  ...
  calendarCloseBtnText: { color: "#333", fontWeight: "700", fontSize: 13 },
