...
// // NOTE: the first entry (value: "") is a placeholder only — it is filtered
// // out of the selection modal (see categoryOptions.filter(...) below) but
// // kept here so the array shape matches what the payload/backend expects.
...
//   },
//   {
//     label: "Static Security Officer",
//     value: "Static Security Officer",
//   },
//   {
//     label: "Patrol Staff",
//     value: "Patrol Staff",
...
//   // },
//   {
//     label: "Security Officer - Monitoring/Control Room",
//     value: "Security Officer - Monitoring/Control Room",
//   },
//   // {
//   //   label: "Security Staff with a Trained Security Dog",
//   //   value: "Security Staff with a Trained Security Dog",
//   // },
//   // {
//   //   label: "Armed Security Officer (Cash-in-Transit / Low-complexity)",
//   //   value: "Armed Security Officer (Cash-in-Transit / Low-complexity)",
//   // },
//   {
...
//   },
//   {
//     label: "Event/Venue Supervisor",
//     value: "Event/Venue Supervisor",
//   },
//   // {
...
//   // Job type / category options — sourced from JOB_TYPE_OPTIONS above.
//   const categoryOptions = JOB_TYPE_OPTIONS;

//   // The "Select type" placeholder (value: "") is only meaningful for a native
//   // <select>. It's excluded from the tappable bottom-sheet list so users
//   // don't see a blank, unselectable row.
//   const selectableCategoryOptions = categoryOptions.filter(
//     (opt) => opt.value !== "",
//   );
...
//               Select Required Documents (if applicable)
//             </Text>
...
//                     style={[
//                       styles.toggleCard,
//                       isActive && styles.toggleCardActive,
//                     ]}
//                   >
...
//                           styles.toggleSwitch,
//                           isActive
//                             ? styles.toggleSwitchYes
//                             : styles.toggleSwitchNo,
//                         ]}
//                       >
//                         {isActive ? (
//                           <>
//                             <Text style={styles.toggleSwitchTextYes}>YES</Text>
//                             <View style={styles.toggleKnob} />
//                           </>
//                         ) : (
//                           <>
//                             <View style={styles.toggleKnob} />
//                             <Text style={styles.toggleSwitchTextNo}>NO</Text>
//                           </>
//                         )}
//                       </View>
//                     </View>
...
//           <View style={styles.sectionCard}>
//             <Text style={styles.inputLabel}>
//               Job Instruction Document (if applicable)
//             </Text>
//             <TouchableOpacity
...
//             >
//               {selectableCategoryOptions.map((opt) => (
//                 <TouchableOpacity
//                   key={opt.value}
