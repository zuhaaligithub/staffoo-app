...
//               "https://staging.apis.staffoo.com.au/storage/";
...
//     // 1. Get the Business/Place name (everything before the first comma)
//     const placeName = data.address.split(",")[0].trim();

//     // 2. Get City and Country
//     const city = data.city ? data.city.trim() : "";
//     const country = data.country ? data.country.trim() : "";

//     // 3. Combine them: "Business Name, City, Country"
//     if (city && country) {
...
//                   {/* 1. Status dikhao sirf agar user customer nahi hai */}
...
//     flexDirection: "row",
//     alignItems: "center",
//     flexWrap: "nowrap", // Forces everything into one line
//     marginTop: 8,
//     gap: 8,
//   },
//   addressChip: {
...
//     color: COLORS.textSecondary,
//     marginLeft: 4,
//     flexShrink: 1, // Allows text to shrink instead of breaking layout
//   },
// });
