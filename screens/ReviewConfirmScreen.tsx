      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.card}>
          ...
          {[
            {
              label: 'Job Title',
              value: jobData.title || capitalizeAllWords(getCategoryDisplay(jobData.category)),
            },
            // {
            //   label: 'Job Category',
            ...
            <>
                ...
                <View key={i} style={styles.rateSegmentCard}>
                  ...
                  <View style={styles.detailsRow}>
                    <View style={styles.detailColumn}>
                      ...
                      <Text style={styles.detailValue}>{item.hours.toFixed(2)}</Text>
                    </View>
              ...
              <View style={styles.totalsBlock}>
                ...
                <View style={[styles.totalLine, styles.totalLineNoBorder]}>
                  ...
                  <Text style={styles.quoteTotalvalue}>${totalIncGST.toFixed(2)}</Text>
                </View>

                {/* Dynamic Discount (WITH LINE) */}
                {selectedPlan === 'full' && (
                  <View style={styles.totalLine}>
                    <Text style={styles.totalLabel}>Pay In Full Discount (5%)</Text>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.noteText}>
              *Note: A 10% Incidental Authorisation Hold May Be Applied By Stripe To
              Cover Potential Unplanned Overtime. The Hold Will Be Released After
