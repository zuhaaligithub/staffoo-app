    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            {acceptedPolicy && <Check size={14} color={COLORS.text} />}
          </View>
          <View style={{ flex: 1 }}>
...
const pmStyles = StyleSheet.create({
  ...
  subtitle: { fontSize: 10, color: LIGHT.textSecondary },
  securedBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  securedText: { fontSize: 8, color: LIGHT.textSecondary },
  ...
  amountBarValue: { color: COLORS.text, fontSize: 12, fontWeight: "800" },
  sectionLabel: {
    fontSize: 12,
    fontWeight: "700",
    color: LIGHT.text,
...
const styles = StyleSheet.create({
  ...
  inputCardText: { fontSize: 11, color: LIGHT.text, fontWeight: "600" },
  attachmentRow: {
    flexDirection: "row",
    alignItems: "center",
    marginTop: 6,
  ...
  paymentOptionsTitle: { fontSize: 14, fontWeight: "800", color: COLORS.text },
  ...
  payNowText: { color: COLORS.text, fontSize: 14, fontWeight: "800" },
  loadingContainer: {
    flex: 1,
    justifyContent: "center",
    alignItems: "center",
